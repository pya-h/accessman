...
const defaults = (size = 18): JSX.SVGAttributes<SVGSVGElement> => ({
  width: size,
  height: size,
  viewBox: '0 0 24 24',
  fill: 'none',
...
export function IconBox({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconImport({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconAlert({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconInbox({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconMonitor({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconType({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconSortAsc({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
...
export function IconSortDesc({ size, ...props }: IconProps) {
  return (
    <svg {...defaults(size)} {...props}>
      <line x1="12" y1="5" x2="12" y2="19" />
